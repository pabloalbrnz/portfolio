...
function App() {
  ...
  return (
    <div className="w-full flex flex-col items-center">
          ...
          <div className="w-full h-full flex justify-between items-center font-source text-neutral-800">
            ...
            <ul className="flex gap-8 items-center justify-center w-1/3">
              <div className="w-1/2 flex justify-end">
                <a href="/">
                  <li className="p-2 rounded-lg select-none">Home</li>
                </a>
              </div>
              <li className="font-bold select-none">×</li>
              <div className="w-1/2 flex justify-start">
                <a href="#projects">
                  <li className="p-2 rounded-lg select-none">Projects</li>
                </a>
              </div>
            </ul>
          ...
          <div className="flex gap-4">
            <div className="rounded hover:rounded-md w-52 bg-neutral-300 border border-neutral-800 hover:border-transparent h-80 flex overflow-hidden group/me noise-light hover:bg-purple-500 transition-all  shadow shadow-transparent hover:shadow-2xl hover:shadow-purple-400 ease-linear">
              <img
                alt="Pablo photo"
                src={me}
                className="h-72 self-end grayscale group-hover/me:grayscale-0 ease-linear drop-shadow-[0_0_12px_rgba(20,15,25,0.1)] group-hover/me:drop-shadow-[0_0_12px_rgba(200,155,255)] transition-all group-hover/me:rotate-[2deg] group-hover/me:scale-110 select-none"
              />
            </div>
      ...
      <div className="h-screen w-full bg-neutral-800" id="projects"></div>
      <div className="fixed -z-10 noise-dark size-full opacity-25" />
      <span className="absolute leading-4 font-source text-2xl rotate-6 opacity-10 top-80 left-[64rem] text-center blur-[0.25px] select-none">
        xxxxxxxxxx
        <br />
        xxxxxxxxxxxx
        <br />
      ...
      <span className="absolute -z-20 leading-4 font-source text-2xl -rotate-[9deg] opacity-10 top-24 left-40 text-center blur-[0.75px] select-none">
        xxxxxxxxxx
        <br />
        xxxxxxxxxxxx
        <br />
      ...
      <div className="absolute ml-[60rem] mt-32 w-48 drop-shadow-[1px_8px_8px_rgba(0,0,0,0.1)] group/polaroid  hover:drop-shadow-[2px_16px_8px_rgba(200,155,255,0.75)] ease-linear transition-all saturate-[0.38] hover:saturate-[0.8] select-none">
        <img
          src={subway1}
      ...
      <span className="absolute text-3xl -hue-rotate-[67.5deg] brightness-75 top-[22rem] rotate-[12deg] select-none hover:-rotate-6 ease-linear transition-transform">
        ✌️
      </span>
      <span className="absolute text-3xl -hue-rotate-[67.5deg] brightness-75 top-[28rem] left-[25.6rem] -rotate-[128deg] select-none hover:-rotate-[102deg] ease-linear transition-transform">
        🤙
      </span>
    </div>
  );
